    ...
    <div class="main">
      ...
      <div class="lastAddedDisplay">
        <div class="titleContainer">
          <p class="lastAddedTitle">About your new game ...</p>
        </div>
        <div class="lastAddedCardContainer">
          <div class="noLastItem">
            <div class="additemFormContainer">
                <div class="inputForm">
                    <v-text-field clearable label="Game Name" v-model="gameName"></v-text-field>
                </div>
    ...
    export default {
        ...
        methods: {
          ...
          async validate() {
              ...
              addDoc(userRef, { UserId, Console, Tags, Name, OriginalBox, Publisher, AllAccessories, State, Particularities, PurchasePrice, Type, AddDate })
                  .then(async (userRef) => {
